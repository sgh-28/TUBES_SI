...
<body>
    <div class="desktop-view">
        <div class="toolbar">
            ...
            <div class="company-name">World Hotel & Resort Raffy Ganteng Banget</div>
        </div>
    </div>
    <div class="container">
        ...
        <div class="image-container">
            ...
            <div class="bars">
                <a href="page1.html" class="bar">Kamar</a>
            </div>
        </div>
        <div class="image-container">
            <img src="daftar.png" alt="Image 3">
            <div class="bars">
                <a href="page1.html" class="bar">Data Tamu</a>
                <a href="page1.html" class="bar">Pembayaran</a>
            </div>
        </div>
        <div class="image-container">
