...
<body>
    <div class="container">
        ...
        <div class="content">
            <img src="twin.jpg" alt="twin Room">
            <div class="details">
                <h3>Twin Room</h3>
                <p>twin Room, facilitated by a larger living room and also
                ...
                <p style="font-size: 19px;"><strong>$100</strong></p>
            </div>
        </div>
        <form action="booking room.php" method="post">
            <input type="text" name="id_kamar" id='id_kamar' value='KM003' hidden>
            <div class="buttons">
                <a href="kamar.php">
